...
```{r pte}
obs_models_151 = list (
  "Age" = lm(data = bac, aged ~ drunk_151*rescaled_bac_151),
  "Male" = lm(data = bac, male ~ drunk_151*rescaled_bac_151),
  "Accident" = lm(data = bac, acc ~ drunk_151*rescaled_bac_151),
  "White" = lm(data = bac, white ~ drunk_151*rescaled_bac_151)
)
...
# Adding the fitted values for age, gender, and accident
bac$fitaged_151 = predict(obs_models_151[["Age"]])
bac$fitmale_151 = predict(obs_models_151[["Male"]])
bac$fitacc_151 = predict(obs_models_151[["Accident"]])
bac$fitwhite_151 = predict(obs_models_151[["White"]])
